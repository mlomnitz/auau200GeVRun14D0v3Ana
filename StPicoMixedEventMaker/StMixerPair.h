...
inline StLorentzVectorF const& StMixerPair::lorentzVector() const
{
   return mLorentzVector;
}
inline float StMixerPair::m()    const
{
   return mLorentzVector.m();
}
inline float StMixerPair::pt()   const
{
   return mLorentzVector.perp();
}
inline float StMixerPair::eta()  const
{
   return mLorentzVector.pseudoRapidity();
}
inline float StMixerPair::phi()  const
{
   return mLorentzVector.phi();
}
inline float StMixerPair::px()   const
{
   return mLorentzVector.px();
}
inline float StMixerPair::py()   const
{
   return mLorentzVector.py();
}
inline float StMixerPair::pz()   const
{
   return mLorentzVector.pz();
}
inline float StMixerPair::pointingAngle() const
{
   return mPointingAngle;
}
inline float StMixerPair::decayLength()   const
{
   return mDecayLength;
}
inline float StMixerPair::particle1Dca()  const
{
   return mParticle1Dca;
}
inline float StMixerPair::particle2Dca()  const
{
   return mParticle2Dca;
}
inline StThreeVectorF const & StMixerPair::particle1Mom() const
{
   return mParticle1Mom;
}
inline StThreeVectorF const & StMixerPair::particle2Mom() const
{
   return mParticle2Mom;
}
inline float StMixerPair::dcaDaughters() const
{
   return mDcaDaughters;
}
inline float StMixerPair::cosThetaStar() const
{
   return mCosThetaStar;
}
inline StThreeVectorF const & StMixerPair::decayVertex() const
{
   return mDecayVertex;
}
inline float StMixerPair::v0x() const
{
   return mDecayVertex.x();
}
inline float StMixerPair::v0y() const
{
   return mDecayVertex.y();
}
inline float StMixerPair::v0z() const
{
