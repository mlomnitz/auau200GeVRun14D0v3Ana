...
inline StLorentzVectorF const & StMixerTriplet::lorentzVector() const
{
   return mLorentzVector;
}
inline float StMixerTriplet::m()    const
{
   return mLorentzVector.m();
}
inline float StMixerTriplet::pt()   const
{
   return mLorentzVector.perp();
}
inline float StMixerTriplet::eta()  const
{
   return mLorentzVector.pseudoRapidity();
}
inline float StMixerTriplet::phi()  const
{
   return mLorentzVector.phi();
}
inline float StMixerTriplet::px()   const
{
   return mLorentzVector.px();
}
inline float StMixerTriplet::py()   const
{
   return mLorentzVector.py();
}
inline float StMixerTriplet::pz()   const
{
   return mLorentzVector.pz();
}
inline float StMixerTriplet::pointingAngle() const
{
   return mPointingAngle;
}
inline float StMixerTriplet::decayLength()   const
{
   return mDecayLength;
}
inline float StMixerTriplet::particle1Dca()  const
{
   return mParticle1Dca;
}
inline float StMixerTriplet::particle2Dca()  const
{
   return mParticle2Dca;
}
inline float StMixerTriplet::particle3Dca()  const
{
   return mParticle3Dca;
}
inline StThreeVectorF const & StMixerTriplet::particle1Mom() const
{
   return mParticle1Mom;
}
inline StThreeVectorF const & StMixerTriplet::particle2Mom() const
{
   return mParticle2Mom;
}
inline StThreeVectorF const & StMixerTriplet::particle3Mom() const
{
   return mParticle3Mom;
}
inline float StMixerTriplet::dcaDaughters12() const
{
   return mDcaDaughters12;
}
inline float StMixerTriplet::dcaDaughters23() const
{
   return mDcaDaughters23;
}
inline float StMixerTriplet::dcaDaughters31() const
{
   return mDcaDaughters31;
}
inline float StMixerTriplet::cosThetaStar() const
{
   return mCosThetaStar;
}
inline StThreeVectorF const & StMixerTriplet::decayVertex() const
{
   return mDecayVertex;
}
inline float StMixerTriplet::v0x() const
{
   return mDecayVertex.x();
}
inline float StMixerTriplet::v0y() const
{
   return mDecayVertex.y();
}
inline float StMixerTriplet::v0z() const
{
   return mDecayVertex.z();
}
#endif
